    ...
    return (
      <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,168,181,0.15)] border-2 border-ziv-cyan hover:shadow-2xl transition-all duration-300 flex flex-col h-full relative">
        ...
        <div className="flex items-center mb-4 mt-2">
          <div className={`w-24 h-24 ${plan.iconBg} rounded-2xl flex items-center justify-center ${plan.iconText} mr-4`}>
            {isImageLogo ? (
              <img src={plan.icon} alt="Logo" className="w-16 h-16 object-contain" />
            ) : (
              <Icon name={plan.icon} className="h-10 w-10" />
            )}
          </div>
  ...
  return (
    <div className={`bg-gray-50 rounded-2xl p-8 shadow-sm border border-gray-200 hover:shadow-xl ${plan.hoverBorder} transition-all duration-300 flex flex-col h-full relative`}>
      <div className="flex items-center mb-4">
        <div className={`w-20 h-20 ${plan.iconBg} rounded-2xl flex items-center justify-center ${plan.iconText} mr-4`}>
          {isImageLogo ? (
            <img src={plan.icon} alt="Logo" className="w-14 h-14 object-contain" />
          ) : (
            <Icon name={plan.icon} className="h-9 w-9" />
          )}
        </div>
