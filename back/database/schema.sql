...
-- STREAMING_CHUNK:Création de la table global_settings...
-- ==============================================================================
-- 7. TABLE : global_settings (Configuration unique du site)
-- ==============================================================================
...
-- STREAMING_CHUNK:Insertion des données de configuration globales...
-- ==============================================================================
-- PEUPLEMENT DE LA BASE (SEEDING) - Démarrage direct du site
-- ==============================================================================

-- 7.1. Global Settings
INSERT IGNORE INTO global_settings (id, seo_title, seo_meta_desc, seo_keywords, chatbot_welcome_msg) 
VALUES (
    1, 
